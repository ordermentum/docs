...
```shell
curl "https://api.ordermentum.com/v1/invoices"
...
```json
{
  ...
  "data": [
    {
      "id": "2f39f720-7abb-4be7-9c0b-98a7800d88ba",
      "createdAt": "2016-12-01T05:44:59.223Z",
      "updatedAt": "2016-12-01T05:44:59.223Z",
      "number": "INV1",
      "supplierId": "d21379b3-0247-4111-9a9a-3bf979397880",
      "supplierName": "Bob's Buns",
      "retailerId": {},
      "retailerName": {},
      "orders": [
        {
      ...
      "orderIds": [
        "e8380038-4e12-4c12-b5b0-b56b46f6381a"
      ],
      "total": "150.20",
      "totalFreight": "10.00",
      "totalGST": "10.00",
      ...
      "status": "Unpaid",
      "paidAt": {},
      "userId": "b682d90f-31b2-4937-ae3a-5eddc58914c6",
      "userName": "Fred Wallaby",
      "paymentMethod": "card",
      "cancelledAt": {},
      "reference": "Invoice #3242",
      "date": "2016-12-01T05:44:59.223Z",
      "payable": true,
      "randomWeight": false,
      "invoiceSyncedAt": {}
    }
...
`GET http://app.ordermentum.com/v1/invoices`
...
```shell
curl "http://app.ordermentum.com/v1/invoices/69B34C71-3D61-4D40-92DE-BD7954D26BD2"
  -H "Authorization: Bearer UNIQUE_TOKEN"
```
...
`GET http://app.ordermentum.com/v1/invoices/<ID>`
...
`PUT http://app.ordermentum.com/invoices/<ID>`
